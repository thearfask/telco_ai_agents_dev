...
class IncidentObjective(BaseModel):
    """
    Small stable incident context that RCA receives every round.
    """
...
class EvidenceKind(str, Enum):
    ...
    INFERRED:
        Domain interpretation produced from evidence.
    """
...
class EvidenceAvailability(str, Enum):
    """
    CURRENT:
        Already known in domain/global state.

    QUERYABLE:
        Not known yet, but available via one of the domain tools.

    UNAVAILABLE:
        Current domains/tools do not contain the required evidence.
    """
...
# ============================================================
# DOMAIN AGENT STRUCTURED OUTPUT
# ============================================================
...
class DomainFindingUpdate(BaseModel):
    """
    Only NEW information from the specialist round.
    """
